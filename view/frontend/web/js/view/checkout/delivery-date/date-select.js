...
define([
...
], function ($, ko, _, Select, $t, deliveryDateList, priceUtils, quote, setShippingInformationAction) {
    "use strict"
    ...
    return Select.extend({
        ...
        updateCurrentDate: function (data) {
            var currDate = deliveryDateList.currentDate,
                newDateItem
        ...
        setDefaultOption: function (data) {
            ...
            if (localStorage.getItem("calcurates_delivery_date")) {
                savedOptionId = localStorage.getItem("calcurates_delivery_date")
        ...
        onChangeDate: function () {
            var currentDateId = this.value(),
                currentDate,
                firstLoad = _.isEmpty(deliveryDateList.currentDate())
            ...
            if (currentDate) {
                localStorage.setItem("calcurates_delivery_date", currentDate.id)
            }
            ...
            if (
                ...
                if (
                    ...
                    (this.valueChangedByUser || firstLoad)
                ) {
                    if (quote.shippingAddress()) {
                        setShippingInformationAction()
                    } else {
                        var runOnce = quote.shippingAddress.subscribe(function () {
                            runOnce.dispose()
                            setShippingInformationAction()
                        })
                    }
        ...
        dateText: function (deliveryDate) {
            ...
            if (window.checkoutConfig.isDisplayShippingPriceExclTax) {
                ...
                formattedPrice =
                    priceUtils.formatPrice(deliveryDate.fee_amount_incl_tax, quote.getPriceFormat()) +
                    " " +
                    $t("Excl. Tax") +
                    ": +" +
        ...
        getTimeSlotDateRequired: function () {
            ...
            return !!(deliveryDatesMetadata && deliveryDatesMetadata.time_slot_date_required === true)
        },
        ...
        validateSelect: function () {
            if (this.getTimeSlotDateRequired() === true && "undefined" === typeof this.value()) {
