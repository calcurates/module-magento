...
class CustomNumber implements OutputProcessorInterface
{
    /**
     * @var string
     */
    private $variableTemplate = '{custom_number}';
    ...
    public function process(DataObject $rateModel, string $stringToProcess): string
    {
        ...
        $customNumber = (float) $rateModel->getData(RatesResponseProcessor::CALCURATES_CUSTOM_NUMBER);
