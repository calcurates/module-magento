...
class CreateShippingLabelCommand
{
    ...
    public function execute(\Magento\Framework\DataObject $request)
    {
        ...
        $taxIds = $request->getOrderShipment()->getData('calcuratesTaxIds');
        ...
        $request->setData('calcurates_service_code', $shippingCarrierData['service']['serviceCode'] ?? $shippingCarrierData['service']['code']); // use code for legacy compatibility SAAS-3689
